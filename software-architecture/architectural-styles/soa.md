...
**Service-Oriented Architecture (SOA)** is an [[software-architecture/architectural-styles/|architectural style]] where business capabilities are exposed and consumed as reusable, enterprise-level **services**. Unlike other styles, classic SOA is defined by its use of a central communication backbone, the **[[esb|Enterprise Service Bus (ESB)]]**, which handles all routing, transformation, and [[business-process-management|orchestration]] logic.
...
3.  **Enterprise Service Bus (ESB):** The central communication hub. It is responsible for:
    ...
    *   **[[business-process-management|Orchestration]]:** Coordinating calls to multiple services to fulfill a single business process.
